 ...
 */
class User extends \Neatline\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'name', 'created', 'modified', 'passwordHash', 'role', 'isActive', 'token', 'keys', 'sites', 'vocabularies', 'resourceClasses', 'properties', 'resourceTemplates'];
        }
    ...
    public function createToken()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'createToken', []);
    ...
    public function deleteToken()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'deleteToken', []);

        return parent::deleteToken();
    }
